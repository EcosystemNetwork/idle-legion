...
export const ASSET_CATALOG: AssetEntry[] = [
  // ── Heroes / Gladiators (1) ──
  { img: `${B}grok-6b7c4d79-19ea-4f0d-85af-d7d4c1d1ee53.jpg`, file: "grok-6b7c4d79-19ea-4f0d-85af-d7d4c1d1ee53.jpg", type: "hero", rarity: "uncommon", name: "Caged Pepe Captive", buyGold: 1200, sellGold: 480, priceUsd: 0.3, desc: "A ragged hooded Pepe gladiator chained inside a rusted wheeled prison cage." },
  // ── Arena Bosses (6) ──
  ...
  { img: `${B}grok-f5d981d0-c917-44ce-adfa-8cc177352d65.jpg`, file: "grok-f5d981d0-c917-44ce-adfa-8cc177352d65.jpg", type: "boss", rarity: "epic", name: "The Toad Warden's Pit", buyGold: 26000, sellGold: 10400, priceUsd: 4, desc: "A caped Pepe gladiator boss commands chained toad slaves in a fiery underground forge arena." },
  // ── Weapons (2) ──
  ...
  { img: `${B}grok-aaadef26-4293-49f3-b048-11beabfd77cd.jpg`, file: "grok-aaadef26-4293-49f3-b048-11beabfd77cd.jpg", type: "accessory", rarity: "epic", name: "Sigillum Rex Slave Seal", buyGold: 1040, sellGold: 415, priceUsd: 0.16, desc: "A dark red wax seal reading Sigillum Rex Slave Seal beside a chain-wrapped Pepe-headed staff." },
  ...
  // ── Chambers / Rooms (1) ──
  { img: `${B}grok-577d050b-b758-4b49-9281-83c80ea9f710.jpg`, file: "grok-577d050b-b758-4b49-9281-83c80ea9f710.jpg", type: "room", rarity: "rare", name: "Ludus Frog Barracks", buyGold: 2200, sellGold: 880, priceUsd: 0.4, desc: "A cutaway underground gladiator school with a training arena, kitchen, bunk barracks, catacombs, and a radio nook full of frog warriors." },
  // ── Raid Locations (4) ──
  { img: `${B}grok-2b47b430-3013-4413-8c00-d77e6ee3e14a.jpg`, file: "grok-2b47b430-3013-4413-8c00-d77e6ee3e14a.jpg", type: "raid", rarity: "rare", name: "Wasteland of Ruined Scrolls", buyGold: 1650, sellGold: 660, priceUsd: 0.3, desc: "A desert battlefield of toppled Roman ruins and meme-carved tombstones where armored frog-gladiators march past a crumbling temple." },
  ...
  { img: `${B}grok-571d567b-f91f-4a5f-913f-762cdef503c0.jpg`, file: "grok-571d567b-f91f-4a5f-913f-762cdef503c0.jpg", type: "raid", rarity: "epic", name: "Ruins of the Normie Wastes", buyGold: 3900, sellGold: 1560, priceUsd: 0.6, desc: "Armored Pepe gladiators led by a BOSS march through a smoldering battlefield of shattered meme-inscribed pillars and statues." },
  { img: `${B}grok-c5fc7200-2655-42cb-98e1-fe808c5cbd9d.jpg`, file: "grok-c5fc7200-2655-42cb-98e1-fe808c5cbd9d.jpg", type: "raid", rarity: "epic", name: "Meme Colosseum", buyGold: 3900, sellGold: 1560, priceUsd: 0.6, desc: "Two armored frog gladiators duel in a neon-lit ruined arena packed with cheering shadowy crowds and floating game controllers." },
  // ── Loot Crates (13) ──
  ...
  { img: `${B}grok-90dbb948-ca0c-4b74-934a-8d332c5d1da1.jpg`, file: "grok-90dbb948-ca0c-4b74-934a-8d332c5d1da1.jpg", type: "crate", rarity: "epic", name: "Atramentum Forum Amphora", buyGold: 1950, sellGold: 780, priceUsd: 0.3, desc: "A cracked stone amphora oozing black ink, sealed with a golden Pepe wax medallion above a titled plaque." },
